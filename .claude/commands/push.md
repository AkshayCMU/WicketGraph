...
- If you cannot safely resolve the issue via standard edits, stop immediately and write a detailed summary of the error to a new file named `push_failure_report.txt` in a folder named 'Push_Failures' in the root directory, then exit.